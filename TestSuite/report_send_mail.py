...
config_path = os.path.abspath(os.path.dirname(os.getcwd())) + '/config.ini'
...
if __name__ == '__main__':
    ...
    test_dir = os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + 'testcase')
    report_dir = os.path.abspath(os.path.dirname(os.getcwd()) + os.path.sep + 'test_report')
    ...
    zip_name = os.path.abspath(os.path.dirname(
        os.getcwd()) + os.path.sep + 'report_backup' + os.path.sep + now + '.zip')
    zip_file = zipfile.ZipFile(zip_name, 'w')
    file_list = os.listdir(report_dir)
    for filename in file_list:
        zip_file.write(report_dir + os.path.sep + filename, filename)
    zip_file.close()
